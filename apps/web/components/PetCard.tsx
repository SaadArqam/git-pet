...
export function PetCard({ petState }: Props) {
  ...
  return (
    <div style={{ background: "#0f172a", border: "2px solid #1e293b", borderRadius: 16, padding: 20, width: "100%", maxWidth: 380, fontFamily: "monospace" }}>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <button
          onClick={handleCopy}
          style={{ flex: 1, background: "transparent", border: `1px solid ${copied ? "#22c55e44" : "#1e293b"}`, color: copied ? "#22c55e" : "#475569", fontFamily: "monospace", fontSize: 9, padding: "10px 0", borderRadius: 6, cursor: "pointer", letterSpacing: 1, transition: "all 0.2s" }}
        >
